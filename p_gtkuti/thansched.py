...
import thantkutila as p_gtkwid
...
class ThanScheduler:
	...
	__preempt: it is used to avoid preemptive calls to the sheduler (wether running or not).
    ...
    def thanSchedule1(self, func, *args):
        ...
        if not self.__running:
            ...
            try:
                ...
                p_gtkuti.thanGudModalMessage(win, mes[1], mes[0], p_gtkuti.ERROR)

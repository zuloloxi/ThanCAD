...
This module imports the element classes and creates o convenient container.
"""

from .thanarc     import ThanArc
from .thanbimcolumn import ThanBimColumn
...
from .thanhatch   import ThanHatch


thanElemClasses = (ThanArc, ThanBimColumn, ThanCircle, ThanDimali, ThanImage,
                   ThanLine, ThanLineFilled, ThanCurve, ThanSpline, ThanEllipse,
                   ThanFace3d, ThanPoint, ThanPointNamed,
                   ThanRoad, ThanText, ThanHatch)

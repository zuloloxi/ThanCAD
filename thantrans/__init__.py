...
Only very limited Greek translation for the moment using iso-8859-7. It has
been proved difficult to support Greek simultaneously for Linux and windows.
What about Mac?
"""
from .thanall import (thanTransAll, T, Tmatch, Tphot, Tarch, Tcivil, Twid, Turban,
    thanLangMore, thanLangSetall)

...
if developer and __name__ == "__main__":
    ...
    if sys.version_info.major >= 3: libsp = "libs3"
    else:                           libsp = "libs2"
    if Windows: sys.path.append("x:\\"+binp+"\\"+libsp)         # Developer environment
    else:       sys.path.append("/home/a12/x/"+binp+"/"+libsp)  # Developer environment

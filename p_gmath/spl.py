...
def testeqspline():
    "Tests the equidistqant spline."
    xx = [float(x1) for x1 in xrange(10)]
    yy = [0.3*x1**1.5 for x1 in xx]
    yy[3] *= 2.0
    yy[7] /= 2.0
    s = EquidistantSpline(yy)
    import p_gchart, p_ggen
    ch = p_gchart.ThanChart(title="Equidistant Spline")

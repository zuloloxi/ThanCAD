...
def thanRegisterMenus():
    ...
    [ ("menu", T["&Research"], ""),           # Menu Title
      ("-",),
      ("imsbimcolumnsettings", Tcivil["&BIM Column Settings"], Tcivil["Adds extra attributes to a BIM Column. For the IMSAFER Reaserach Program"]),
      ("endmenu",),
    ]
    ...
    #If "aftermenu" does not exist (eg it is blank), then menuname is inserted just before the last menu ("help" menu)
    ...
    seq = [("Research", "", ""),    #Sequence of menus: existing menu "Engineering", entries are added ath the end of the menu
          ]
    return seq, m

...
This module defines line states, i.e. as the user moves the mouse, am ellipse
...
class ThanStateEllipseb(ThanStateGeneric):
    ...
    def thanZoomXyr(self, x, y, fact):
        "Change internal coordinates according to zoom; this fuction should be here (in the state objects)."

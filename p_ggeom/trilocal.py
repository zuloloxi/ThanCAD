...
class TriLocal:
    "A triangle tranformation from local<->global coordinates."
    def __init__(self, x1, y1, x2, y2, x3, y3):
      """Tranforms global to local coordinate sin a triangle.
...
c     accuracy.
    ...
    def glob2loc(self, x, y):
      "Tranforms global to local coordinates."
      xx3 = x - self.x3Dat
      yy3 = y - self.y3Dat
    ...
    def loc2glob(self, l1, l2, l3):
      """Tranforms local to global coordinates.
